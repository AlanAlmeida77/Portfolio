    ...
    return (
            ...
            <div className="h-full lg:py-40 flex flex-col justify-center lg:items-start items-center text-white ">
                <h1 data-aos='fade-right' className="text-[52px] font-semibold mb-8 leading-normal text-fuchsia-500 uppercase">About me</h1>
                    <p data-aos='fade-right justify-center' >Full-Stack developer focused on Frontend. Currently studying programming at Teclab. I was diagnosed with type 1 diabetes at the age of 21, which gave me adaptability and determination. With experience in customer service, radio and NGOs, I have solid skills in communication, teamwork and problem solving.
                    My self-taught background in development since 2021 and Henry course in 2022 have strengthened my technical skills. I specialize in the PERN stack, with knowledge in MERN, TypeScript and NextJS. My advanced level of English (C1) facilitates international communication.
                    My goals are to apply my skills in solutions beneficial to society. I am looking to integrate into a collaborative and dynamic team, contribute and learn. Open to remote opportunities, my focus is to grow professionally and generate positive impact through technology. Connect with me to explore new opportunities in software development.</p>
